...
const useSignaling = (roomId)=>{
    ...
    const lastFetchedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(Date.now());
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSignaling.useEffect": ()=>{
            if (!roomId) return;
            const interval = setInterval({
                "useSignaling.useEffect.interval": async ()=>{
                // Simulation: Check a global or local store for messages
                // This part would normally be socket.on('message')
                }
            }["useSignaling.useEffect.interval"], 1000);
            return ({
                "useSignaling.useEffect": ()=>clearInterval(interval)
            })["useSignaling.useEffect"];
        }
    }["useSignaling.useEffect"], [
        roomId
...
_s(useSignaling, "LG1Ue1DJD8DgdiiPugIc3n9xLh8=");
const generateId = ()=>{
...
function FileJet() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FileJet.useEffect": ()=>{
            setMyId((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$signaling$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateId"])());
        }
    }["FileJet.useEffect"], []);
            ...
            setTimeout(()=>{
                if (dataChannel.current && dataChannel.current.readyState !== 'open') {
                    ...
                    toast({
                        ...
                        description: "Linked with Peer ".concat(recipientId)
                    });
                }
            }, 2000);
        } catch (err) {
...
_s(FileJet, "RKSkSrzpbu8NLkQ1QKaFU65Ca0s=", false, function() {
    return [
...
//# sourceMappingURL=_b0c5d8eb._.js.map